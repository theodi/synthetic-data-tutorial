...
nhs_hospitals_london = os.path.join(data_dir, 'hospitals_london.txt')
nhs_ae_treatment_codes = os.path.join(data_dir, 'treatment_codes_nhs_ae.csv')
...
nhs_ae_data_deidentify = os.path.join(data_dir, 'nhs_ae_data_deidentify.csv')
